...
<div class="wrapper">
    ...
    <?php if (isset($_SESSION['message'])): ?>
      ...
      <input name="loginEmail" type="text" class="form-control mb-3" name="username" placeholder="Email Address" required="" autofocus="" />
      <input name="loginPassword" type="password" class="form-control mb-4" name="password" placeholder="Password" required=""/>      
